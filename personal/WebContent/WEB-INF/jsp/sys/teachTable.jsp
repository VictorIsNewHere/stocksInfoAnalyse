		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">教练信息列表</a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form method="post" action="${domain}/sys/teachTable">
                                                                                                    教练姓名：<input type="text" name="tname" id="tname" value="${tname}" style="height:28px;">
                                            <input type="submit" value="搜索" class="btn btn-info btn-fill "></form>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach var="list" items="${findTeachList}" varStatus="status">
                                        <tr>
                                        	<%-- <td>${list.id}</td> --%>
